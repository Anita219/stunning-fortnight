defmodule WarmupOneMarineTest do
  ...
  test "not_string" do
    ...
    assert WarmupOneMarine.not_string("not bad") == "not bad"
  end

  test "missing char" do
    assert WarmupOneMarine.missing_char("kitten", 1) == "ktten"
    assert WarmupOneMarine.missing_char("kitten", 0) == "itten"
    assert WarmupOneMarine.missing_char("kitten", 4) == "kittn"
  end

  test "front_back" do
    assert WarmupOneMarine.front_back("super cat") == "tuper cas"
    assert WarmupOneMarine.front_back("a") == "a"
    assert WarmupOneMarine.front_back("ab") == "ba"
  end

  test "front3" do
    assert WarmupOneMarine.front3("Java") == "JavJavJav"
    assert WarmupOneMarine.front3("a") == "aaa"
    assert WarmupOneMarine.front3("Maman") == "MamMamMam"
  end
end
